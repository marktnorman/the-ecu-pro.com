...
//    'tax:product_type' => 'Product Type',
//    'tax:product_visibility' => 'Product Visibility',
//    'tax:product_cat' => 'Catergories',
//    'tax:product_tag' => 'Tags',
//    'tax:product_shipping_class' => 'shipping Classes)',
    ...
    foreach ($product_taxonomies as $taxonomy) {
        ...
        $taxonomies['tax:' . wf_piep_helper::format_data($taxonomy->name)] =  wf_piep_helper::format_data($taxonomy->name);
    }
...
return apply_filters('wt_woocommerce_csv_product_post_columns', $post_columns);
