...
$auto_pro_use_implicit_ftp = isset($settings['auto_pro_use_implicit_ftp']) ? $settings['auto_pro_use_implicit_ftp'] : '';
...
$pro_auto_export_delimiter = isset($settings['pro_auto_export_delimiter']) ? $settings['pro_auto_export_delimiter'] : '';
...
$pro_auto_export_prod_status = isset($settings['pro_auto_export_prod_status']) ? $settings['pro_auto_export_prod_status'] : '';
...
$pro_auto_import_multiple_files_import = isset($settings['pro_auto_import_multiple_files_import']) ? $settings['pro_auto_import_multiple_files_import'] : 0;
...
$pro_auto_use_chidren_sku = isset($settings['pro_auto_use_chidren_sku']) ? $settings['pro_auto_use_chidren_sku'] : 0;
...
$rev_use_sftp = isset($settings['rev_use_sftp']) ? $settings['rev_use_sftp'] : '';
...
$rev_auto_replycolumn = isset($settings['rev_auto_replycolumn']) ? $settings['rev_auto_replycolumn'] : 0;
...
$pro_auto_import_url_new_prod_status = isset($settings['pro_auto_import_url_new_prod_status']) ? $settings['pro_auto_import_url_new_prod_status'] : '';
$pro_auto_import_url_use_chidren_sku = isset($settings['pro_auto_import_url_use_chidren_sku']) ? $settings['pro_auto_import_url_use_chidren_sku'] : 0;
$pro_auto_import_url_merge_empty_cells = isset($settings['pro_auto_import_url_merge_empty_cells']) ? $settings['pro_auto_import_url_merge_empty_cells'] : 0;


//For Product and Review Test FTP 
wp_enqueue_script('woocommerce-prod-all-piep-test-ftp', plugins_url(basename(plugin_dir_path(WF_ProdImpExpCsv_FILE)) . '/js/piep_test_ftp_connection.js', basename(__FILE__)),array(),WT_PROD_IMP_EXP_VER);
$xa_prod_all_piep_ftp = array('admin_ajax_url' => admin_url('admin-ajax.php'),'wt_nonce'=> wp_create_nonce(WF_PROD_IMP_EXP_ID));
...
$ftp_text= 'FTP';
/*if (class_exists('class_wf_sftp_import_export') && ( $pro_use_sftp == 1 || $rev_use_sftp == 1)) {
    $ftp_text= 'sFTP';
} else {
    $ftp_text= 'FTP';
}*/
...
<div class="tool-box">
    ...
    <form action="<?php echo admin_url('admin.php?page=wf_woocommerce_csv_im_ex&action=settings'); ?>" method="post">
        <?php wp_nonce_field( WF_PROD_IMP_EXP_ID, 'wt_nonce' ); ?>
        <div class="tool-box bg-white p-20p">
            <h3 class="title aw-title"><?php echo sprintf(__('%s Settings for Import/Export Products', 'wf_csv_import_export'),$ftp_text); ?></h3>
            <table class="form-table">
                <tr style="">
                    <th style="">
                        <label for="pro_enable_ftp_ie"><?php echo sprintf(__('Enable %s', 'wf_csv_import_export'),$ftp_text ); ?></label>
                    </th>
                    <td>
                    ...
                    <td colspan="2">
                        <div style=" ">
                            <table class="form-table" id="pro_export_section_all">
                                ...
                                <tr>
                                    <th>
                                        <label for="pro_use_implicit_ftp"><?php _e('Implicit FTP over TLS ?', 'wf_csv_import_export'); ?></label>
                                    </th>
                                    <td>
                                        <input type="checkbox" name="auto_pro_use_implicit_ftp" id="pro_use_implicit_ftp" class="checkbox" <?php checked($auto_pro_use_implicit_ftp, 1); ?> />
                                ...
                                <tbody class="pro_export_section">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select id="v_prod_types" multiple name="pro_auto_export_prod_status[]" data-placeholder="<?php _e('All Status', 'wf_csv_import_export'); ?>" class="wc-enhanced-select" multiple="multiple">
                                                <?php
                                                foreach ($prod_status as $type_name) {

                                                    if (!empty($pro_auto_export_prod_status) && in_array($type_name, $pro_auto_export_prod_status))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="delimiter" id="v_delimiter" value="<?php echo $pro_auto_export_delimiter; ?>" placeholder="<?php _e(',', 'wf_csv_import_export'); ?>" class="input-text" />
                                ...
                                <tbody class="pro_import_section">
                                    ...
                                    <tr>
                                        <th>
                                            <label for="pro_auto_import_multiple_files_import"><?php _e('Import From Folder', 'wf_csv_import_export'); ?></label>
                                        </th>
                                        <td>
                                            <input type="checkbox" name="pro_auto_import_multiple_files_import" id="pro_auto_import_multiple_files_import"  class="checkbox" <?php checked($pro_auto_import_multiple_files_import, 1); ?> />
                                             <p style="font-size: 12px"><?php _e('Enabling this will import all files from the specified folder', 'wf_csv_import_export'); ?></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                            <label id='wt_import_file_lbl' for="pro_auto_import_file"><?php _e('Import File', 'wf_csv_import_export'); ?></label>
                                        </th>
                                        <td>
                                            ...
                                            <p style="font-size: 12px" id='wt_import_file_hint'><?php _e('Enter the complete path of the CSV file to be imported,separated by commas to import multiple files', 'wf_csv_import_export'); ?></p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>
                                            <label for="pro_auto_use_chidren_sku"><?php _e('Use SKU to link grouped products', 'wf_csv_import_export'); ?></label><br/>
                                        </th>
                                        <td>
                                            <input type="checkbox" name="pro_auto_use_chidren_sku" id="prod_auto_use_chidren_sku"  class="checkbox" <?php checked($pro_auto_use_chidren_sku, 1); ?> />
        ...
        <div class="tool-box bg-white p-20p">
            <h3 class="title aw-title"><?php echo sprintf(__('%s Settings for Import/Export Reviews', 'wf_csv_import_export'),$ftp_text ); ?></h3>
            <table class="form-table">

                <tr>
                    <th>
                        <label for="rev_enable_ftp_ie"><?php echo sprintf(__('Enable %s', 'wf_csv_import_export'),$ftp_text ); ?></label>
                    </th>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <table class="form-table" id="rev_export_section_all">
                            ...
                            <tr>
                                <th>
                                    <label for="rev_ftp_user"><?php echo sprintf(__('%s User Name', 'wf_csv_import_export'),$ftp_text ); ?></label>
                                </th>
                                <td>
                            ...
                            <tbody class="rev_export_section">
                                ...
                                <tr style="border-bottom: 1px solid #f1f1f1">
                                    <th>
                                        <label for="rev_auto_replycolumn"><?php _e('Review with replies', 'wf_csv_import_export'); ?></label>
                                    </th>
                                    <td>
                                        <input type="checkbox" name="rev_auto_replycolumn" id="rev_auto_replycolumn" class="checkbox" <?php checked($rev_auto_replycolumn, 1); ?> />
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="form-table" id="pro_import_from_url_section_all">
                            <tbody class="pro_import_from_url_section">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="pro_auto_import_url" id="pro_auto_import_url" value="<?php echo $pro_auto_import_url; ?>" placeholder="For example http://hostname/temp.csv"/>
                                        <p style="font-size: 12px"><?php _e('Complete URL path including name,separated by commas to import multiple files', 'wf_csv_import_export'); ?></p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="pro_auto_import_url_new_prod_status" id="pro_auto_import_url_new_prod_status" placeholder="draft / pending / publish " value="<?php echo $pro_auto_import_url_new_prod_status ?>"/>
                                        <span style="font-size: 12px"><?php _e('<br /> Change the product status (draft/pending/published) of all the new products imported overriding the existing status', 'wf_csv_import_export'); ?></span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>
                                        <label for="pro_auto_import_url_use_chidren_sku"><?php _e('Use SKU to link grouped products', 'wf_csv_import_export'); ?></label><br/>
                                    </th>
                                    <td>
                                        <input type="checkbox" name="pro_auto_import_url_use_chidren_sku" id="pro_auto_import_url_use_chidren_sku"  class="checkbox" <?php checked($pro_auto_import_url_use_chidren_sku, 1); ?> />
                                        <p style="font-size: 12px"><?php _e(' Check this to link grouped products using product SKUs instead of product IDs', 'wf_csv_import_export'); ?></p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th><label><?php _e('Merge empty cells', 'wf_csv_import_export'); ?></label><br/></th>
                                    <td>
                                        <input type="checkbox" name="pro_auto_import_url_merge_empty_cells" class="checkbox" <?php checked($pro_auto_import_url_merge_empty_cells, 1); ?> />
                                        <span  style="font-size: 12px"><?php _e('Check to merge the empty cells in CSV, otherwise empty cells will be ignored', 'wf_csv_import_export'); ?></span>
                                    </td>
                                </tr> 
    ...
    <script>
        ...
        jQuery(document).ready(function(){
            ...
            jQuery('#pro_auto_import_multiple_files_import').click(function(){

                if(jQuery(this).is(":checked")){
                    jQuery("#wt_import_file_lbl").html('Import Folder');
                    jQuery("#wt_import_file_hint").html('Enter the complete folder path to be imported');
                   

                } else if(jQuery(this).is(":not(:checked)")){

                     jQuery("#wt_import_file_lbl").html('Import File');
                      jQuery("#wt_import_file_hint").html('Enter the complete path of the CSV file to be imported,separated by commas to import multiple files');
        ...
        jQuery(window).load(function() {
                if(jQuery('#pro_auto_import_multiple_files_import').is(":checked")){
                    jQuery("#wt_import_file_lbl").html('Import Folder');
                    jQuery("#wt_import_file_hint").html('Enter the complete folder path to be imported');
