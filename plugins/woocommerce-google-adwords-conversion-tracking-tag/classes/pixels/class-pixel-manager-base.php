...
class Pixel_Manager_Base
{
    ...
    protected function can_order_confirmation_be_processed( $order ) : bool
    {
        ...
        if ( $this->is_nodedupe_parameter_set() || !$order->has_status( 'failed' ) && !current_user_can( 'edit_others_pages' ) && $conversion_prevention == false && (!$this->options['shop']['order_deduplication'] || $this->has_conversion_pixel_already_fired( $order ) != true) ) {
