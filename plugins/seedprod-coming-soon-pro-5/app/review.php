	...
	public function review() {
		...
		<div class="notice notice-info is-dismissible seedprod-review-notice">
			...
			<div class="seedprod-review-step seedprod-review-step-3" style="display: none">
				...
				<p>
					<a href="https://wordpress.org/support/plugin/seedprod/reviews/?filter=5#new-post" class="seedprod-dismiss-review-notice seedprod-review-out" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Ok, you deserve it', 'seedprod-pro' ); ?></a><br>
