...
*/
update_option('seedprod_api_token', 'seedprod_api_token');
update_option('seedprod_api_key','seedprod_api_key');
update_option('seedprod_api_message', 'seedprod_api_message');
update_option('seedprod_license_name', 'Elite');
update_option('seedprod_a', true);
update_option('seedprod_per', 'seedprod_per');
/**
 * Default Constants
 */
define('SEEDPROD_PRO_BUILD', 'pro');
define('SEEDPROD_PRO_SLUG', 'seedprod-coming-soon-pro-5/seedprod-coming-soon-pro-5.php');
define('SEEDPROD_PRO_VERSION', '6.0.8.2');
