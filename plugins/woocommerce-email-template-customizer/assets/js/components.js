...
//Content
    ...
    // if (viWecParams.WC_Subscriptions) {
    //
    //     ViWec.Components.registerCategory('wc_subscriptions', 'WooCommerce Subscriptions');
    //     ViWec.Components.add({
    //         type: "html/wc_subscriptions",
    //         name: 'Subscription info',//i18n['spacer'],
    //         icon: 'transfer',
    //         category: 'wc_subscriptions',
    //         html: viWecTmpl('viwec-wc-subscriptions', {}),
    //         properties: [
    //             headerGroup('translate', 'Translate'),
    //             translateField('Start date', 'start_date', '.viwec-subscription-start_date'),
    //             translateField('End date', 'end_date', '.viwec-subscription-end_date'),
    //             translateField('Recurring total', 'recurring_total', '.viwec-subscription-recurring_total'),
    //
    //             /*Style*/
    //             //Header
    //             headerGroup('header', 'Header', true),
    //             fontSize('.viwec-subscription-header'),
    //             fontWeight('.viwec-subscription-header'),
    //             lineHeight('.viwec-subscription-header'),
    //             textColor('.viwec-subscription-header'),
    //             bgColor('.viwec-subscription-header'),
    //
    //             //Body
    //             headerGroup('body', 'Body', true),
    //             fontSize('.viwec-subscription-body'),
    //             fontWeight('.viwec-subscription-body'),
    //             lineHeight('.viwec-subscription-body'),
    //             textColor('.viwec-subscription-body'),
    //             bgColor('.viwec-subscription-body-odd', 'Odd row color'),
    //             bgColor('.viwec-subscription-body-even', 'Even row color'),
    //
    //             headerGroup('border', 'Border', true),
    //             borderColor('.viwec-subscription-border'),
    //             borderStyle('.viwec-subscription-border'),
    //             attrsGroupLabel('Width(px)', true),
    //             borderLeft('.viwec-subscription-border'),
    //             borderTop('.viwec-subscription-border'),
    //             borderRight('.viwec-subscription-border'),
    //             borderBottom('.viwec-subscription-border'),
    //         ],
    //
    //     });
    //
    //
    //     ViWec.Components.add({
    //         type: "html/wc_subscriptions_switched",
    //         name: 'Subscription info',
    //         icon: 'transfer',
    //         category: 'wc_subscriptions',
    //         html: viWecTmpl('viwec-wc-subscriptions-switched', {}),
    //         properties: [
    //             headerGroup('translate', 'Translate'),
    //             translateField(__('Title', 'viwec-email-template-customizer'), 'title', '.viwec-wc-subscriptions-trans-title'),
    //             translateField(__('Product', 'viwec-email-template-customizer'), 'product', '.viwec-subscription-product'),
    //             translateField('Quantity', 'quantity', '.viwec-subscription-quantity'),
    //             translateField('Price', 'price', '.viwec-subscription-price'),
    //             translateField('Subtotal:', 'subtotal', '.viwec-subscription-subtotal'),
    //             translateField('Discount:', 'discount', '.viwec-subscription-discount'),
    //             translateField('Shipping:', 'shipping', '.viwec-subscription-shipping'),
    //             translateField('Payment method:', 'payment_method', '.viwec-subscription-payment_method'),
    //             translateField('Total:', 'total', '.viwec-subscription-total'),
    //
    //             // ...textGroup('header', '.viwec-subscription-header', 'Header'),
    //             /*Style*/
    //             //Title
    //             headerGroup('subs_title', 'Subscription number', true),
    //             fontSize('.viwec-wc-subscriptions-title'),
    //             lineHeight('.viwec-wc-subscriptions-title'),
    //             textColor('.viwec-wc-subscriptions-title'),
    //             bgColor('.viwec-wc-subscriptions-title'),
    //
    //             //Header
    //             headerGroup('header', 'Header', true),
    //             fontSize('.viwec-subscription-header'),
