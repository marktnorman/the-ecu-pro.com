        ...
        public static function fp_rac_frontend_checkout_external_js() {
            if (!is_user_logged_in()) {
                ...
                wp_localize_script('rac_guest_handle', 'rac_guest_params', array(
                    ...
                    'email_label' => get_option('rac_guest_add_to_cart_popup_heading'),
                    ...
                    'is_cookie_already_set' => isset($_COOKIE['raccookie_guest_email']) && filter_var($_COOKIE['raccookie_guest_email'], FILTER_VALIDATE_EMAIL) ? true : false,
                    'fp_rac_popup_email' => isset($_COOKIE['raccookie_guest_email']) && filter_var($_COOKIE['raccookie_guest_email'], FILTER_VALIDATE_EMAIL) ? $_COOKIE['raccookie_guest_email'] : ''
                ));
