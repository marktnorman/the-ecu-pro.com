        ...
        public static function fp_rac_menu_options_email() {
            ...
            return apply_filters( 'woocommerce_fpracadvance_settings' , array (
                ...
                array (
                    ...
                    'std'     => __( 'Please enter your email' , 'recoverabandoncart' ) ,
                    'default' => __( 'Please enter your email' , 'recoverabandoncart' ) ,
                    'type'    => 'text' ,
                ...
                array (
                    'name'    => __( 'Error message for empty field' , 'recoverabandoncart' ) ,
                    'id'      => 'rac_guest_popup_err_msg_for_empty' ,
                    'std'     => __( 'Enter email address' , 'recoverabandoncart' ) ,
                    'default' => __( 'Enter email address' , 'recoverabandoncart' ) ,
                    'type'    => 'text' ,
                    'newids'  => 'rac_guest_popup_err_msg_for_empty' ,
                    'class'   => 'rac_show_hide_settings_for_guest_popup'
                ) ,
                array (
                    'name'    => __( 'Error message for Invalid email' , 'recoverabandoncart' ) ,
                    'id'      => 'rac_guest_popup_err_msg_for_invalid_email' ,
                    'std'     => __( 'Not a valid email address' , 'recoverabandoncart' ) ,
                    'default' => __( 'Not a valid email address' , 'recoverabandoncart' ) ,
                    'type'    => 'text' ,
