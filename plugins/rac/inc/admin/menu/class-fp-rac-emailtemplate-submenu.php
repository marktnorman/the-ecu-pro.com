...
if (!class_exists('FP_RAC_Email_Template_Table')) {
    ...
    class FP_RAC_Email_Template_Table {
        ...
        public static function init() {
            ...
            add_action('edit_form_after_title', array(__CLASS__, 'fp_rac_do_meta_boxes_affter_title'), 10, 1);
        ...
        public static function fp_rac_add_meta_box_email_template($post_type) {
            ...
            if (!isset($_GET['rac_send_email'])) {
                add_meta_box('rac_save_button', __('Save', 'recoverabandoncart'), 'FP_RAC_Email_Template_Table::fp_rac_display_email_template_save_meta_box', 'racemailtemplate', 'side');
            }
            add_meta_box('rac_test_send_mail', __('Send Test Email', 'recoverabandoncart'), 'FP_RAC_Email_Template_Table::fp_rac_display_email_template_send_mail_meta_box', 'racemailtemplate', 'side');
            add_meta_box('rac_template_layout', __('Email Template', 'recoverabandoncart'), 'FP_RAC_Email_Template_Table::fp_rac_display_email_template_meta_box', 'racemailtemplate', 'normal');
        }
         ...
         * Create New Meta Box. 
         */
        public static function fp_rac_do_meta_boxes_affter_title($post) {
            if ($post->post_type != 'racemailtemplate')
                return;

            global $wp_meta_boxes;
            $backup_meta_boxes = $wp_meta_boxes;
            $new_meta_boxes = $wp_meta_boxes['racemailtemplate']['normal']['default']['rac_template_layout'];
            $wp_meta_boxes = false;
            $wp_meta_boxes['racemailtemplate']['normal']['default']['rac_template_layout'] = $new_meta_boxes;
            do_meta_boxes(null, 'normal', $post);
            $wp_meta_boxes = false;
            $wp_meta_boxes = $backup_meta_boxes;
            remove_meta_box('rac_template_layout', 'racemailtemplate', 'normal');
        }
