                        ...
                        <article class="page type-page status-publish">
                            <div class="page-content">
                                <div class="process-container">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/3-step-process-large.png' ?>"/>
                                </div>
                                <div class="steps-outer-container">
                                    <ul>
                                        <li class="one">
                                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/awesome-phone.png' ?>" />
                                            <p>Call us - our experts will tell you exactly what we need to fix your
                                                problem.</p>
                                        </li>
                                        <li class="two">
                                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/Icon-awesome-bookmark.png' ?>" />
                                            <p>Book our express collection service</p>
                                        </li>
                                        <li class="three">
                                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/material-directions-car.png' ?>"/>
                                        ...
                                        <div class="col-lg-6 second">
                                            <div class="youtube-video-container">
                                                <iframe width="560" height="315"
                                                        src="https://www.youtube.com/embed/JESCRzDYdqE" frameborder="0"
                                            ...
                                            <div class="products-outer">
                                                ...
                                                foreach ($products as $product) {
                                                    ...
                                                    <a class="products-permalink"
                                                       href="<?php echo get_the_permalink($post_id); ?>">View service</a>
                                ...
                                <div class="more-info-outer-container homepage-section-outer">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-4">
                                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/more-info-black.png' ?>"/>
                                        </div>
                                        <div class="col-8">
