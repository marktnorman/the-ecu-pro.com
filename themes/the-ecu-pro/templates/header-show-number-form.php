...
<a href="#" class="phone-toggle d-lg-none text-white" data-js-ref="ctvnf-click-to-show"><i class="fas fa-phone"></i><span class="sr-only">Phone</span></a>
<?php
...
?>
<div id="ctvnf-form-cont-sm" class="ctvnf-form-cont text-center d-lg-none <?= $show_number ? 'is-open' : ''; ?>" data-js-ref="ctvnf-form-cont-sm">
...
<div id="ctvnf-form-cont" class="ctvnf-form-cont text-left <?= $show_ctvnf_form_with_error ? 'is-open' : ''; ?>" data-js-ref="ctvnf-form-cont">
  <?php if ($show_number) { ?>
    <script>
  ...
  <?php } else {
    ...
    <form id="<?=$which_form?>" name="form" class="label-placeholder-form" data-js-ref="lap-form" method="post">
      ...
      <div class="field <?php field_error_class($tecup_form_error, $which_form, 'first', 'required'); ?>">
        ...
        <input id="ctvnf-fname" type="text" maxlength="255" name="first" data-js-ref="lap-form-input" data-js-label-id="ctvnf-label-fname" value="<?=$_POST['first'] ?? ''?>">
      </div>
      <div class="field">
        <label id="ctvnf-label-lname" for="ctvnf-lname">Last name</label>
        <input id="ctvnf-lname" type="text" maxlength="255" name="last" data-js-ref="lap-form-input" data-js-label-id="ctvnf-label-lname" value="<?=$_POST['last'] ?? ''?>">
      </div>
      <div class="field">
      ...
      <div class="field  <?php field_error_class($tecup_form_error, $which_form, 'email', 'email'); ?>">
        ...
        <input id="ctvnf-email" data-js-ref="lap-form-input" data-js-label-id="ctvnf-label-email" type="email" maxlength="255" name="email" value="<?=$_POST['email'] ?? ''?>">
      </div>
      <div class="field">
        <button type="submit" class="button text-center" data-js-ref="lap-form-submit">Show phone number</button>
      </div>
      <div class="field">
