...
<div id="ctvnf-form-cont" class="ctvnf-form-cont text-left <?= $show_ctvnf_form_with_error ? 'is-open' : ''; ?>"
    ...
    //formMsg($which_form) ?>
    <!--        <form id="-->
    <? //= $which_form ?><!--" name="form" class="label-placeholder-form" data-js-ref="lap-form" method="post">-->
    <!--            <input type="hidden" name="redirect_url" value="-->
    <? //= get_the_permalink() ?><!--?show-number=true">-->
    ...
    <!--            <div class="field -->
    <?php //field_error_class($tecup_form_error, $which_form, 'first', 'required'); ?><!--">-->
    ...
    <!--            </div>-->
    <!--            <div class="field  -->
    <?php //field_error_class($tecup_form_error, $which_form, 'email', 'email'); ?><!--">-->
