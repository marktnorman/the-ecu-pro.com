...
?>
<div id="ctvnf-sm" class="ctvnf text-center p-3 d-lg-none <?= $tecup_form_show_number ? 'is-open' : ''; ?>" data-js-ref="ctvnf-sm">
  <div class="ctvnf-box p-3 px-5">
    <span class="ctvnf-close" data-js-ref="ctvnf-close"><img src="<?=get_template_directory_uri()?>/assets/images/x.svg" alt="close" class="img-fluid"><span class="sr-only">Close</span></span>
  ...
  <div class="ctvnf-box p-3">
      ...
      <form id="<?=$which_form?>" name="form" class="label-placeholder-form" data-js-ref="lap-form" method="post">
        ...
        <div class="field <?php field_error_class($tecup_form_error, $which_form, 'first', 'required'); ?>">
          ...
          <input id="ctvnf-fname" type="text" maxlength="255" name="cname" data-js-ref="lap-form-input" data-js-label-id="ctvnf-label-fname" value="<?=$_POST['cname'] ?? ''?>">
        </div>
        <div class="field">
        ...
        <div class="field">
          <button type="submit" class="button lap-form-button text-center" data-js-ref="lap-form-submit">Show phone number</button>
        </div>
        <div class="field">
