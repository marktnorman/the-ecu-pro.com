      ...
      <div class="container header-row">
        ...
        <div class="header-center">
          <div class="searchform-popup">
            ...
            <form action="<?php echo esc_url(home_url('/')); ?>" method="get" class="searchform searchform-cats" role="search" wtx-context="33BF3DF1-8256-4006-9B74-F0D143CC8FF7">
              <div class="searchform-fields">
                <span class="text"><input name="s" type="text" value="" placeholder="Search ECU By Part Number" autocomplete="off" wtx-context="2D496482-E9B3-4959-8883-094627C44992"></span>
                <input type="hidden" name="post_type" value="product" wtx-context="DEBF0DCA-B3BF-45F4-872B-219449C3CBB3">
                <select name="category" id="product_cat" class="cat" tabindex="0" wtx-context="E8339C9E-E4A6-4809-B265-7B9E247209D2">
...
<div class="page-wrapper">
    ...
    <div id="main" class="column1 boxed no-breadcrumbs"><!-- main -->
        ...
        <?php if (is_front_page()) { ?>
            <div id="home-background-image" style="background: url('<?php echo wp_get_attachment_url(get_post_thumbnail_id($post->ID)); ?>') no-repeat center center;" class="">
