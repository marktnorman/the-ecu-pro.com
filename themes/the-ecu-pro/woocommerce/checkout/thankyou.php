...
<div class="woocommerce-order">
    ...
    if ($order) :
        ...
        <p class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed"><?php esc_html_e(
        ...
        <p class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed-actions">
            <a href="<?php echo esc_url($order->get_checkout_payment_url()); ?>" class="button pay"><?php esc_html_e(
                    'Pay',
                    'woocommerce'
                ); ?></a>
    ...
    <?php else :
        ...
        $custom_message = '<div style="margin-bottom: 20px;"><table class="td order-form-table" cellspacing="0" cellpadding="4">
				<tr>
					...
					<a class="thank-you-form-button" href="' . $orderLink . '" target="_blank">Complete online work order</a><br />
					The form is in your email with the order confirmation.</p>
					</th>
				</tr>
			</table></div>';
        ...
        <p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters(
        ...
        <ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details">
            ...
            <li class="woocommerce-order-overview__order order">
                ...
                <strong><?php echo $order->get_order_number(
                    ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                    ?></strong>
            </li>
            ...
            <li class="woocommerce-order-overview__date date">
                ...
                <strong><?php echo wc_format_datetime(
            ...
            <?php if (is_user_logged_in() && $order->get_user_id() === get_current_user_id(
                ...
                <li class="woocommerce-order-overview__email email">
                    ...
                    <strong><?php echo $order->get_billing_email(
